...
### Languages
- TypeScript, JavaScript, Python, HTML, CSS, Java, PHP, C#, Go, Rust, C++, C, Swift, Kotlin, Ruby, Scala

### Frameworks
- React, Vue, Angular, Next.js, Nuxt.js, Node.js, Django, FastAPI, Laravel, Express, Redux, Sass, Tailwind CSS, Bootstrap, Storybook
